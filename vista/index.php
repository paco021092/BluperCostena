...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="../blupper_templete/Dashor_v1.1.0/Admin/vertical/assets/images/favicon.ico">
            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        ...
                        <a href="index.html" class="logo"><img src="../blupper_templete/Dashor_v1.1.0/Admin/vertical/assets/images/logo.png" height="14" alt="logo"></a>
                    </div>
                </div>
                            ...
                            <ul class="list-inline float-right mb-0">
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="../blupper_templete/Dashor_v1.1.0/Admin/vertical/assets/images/users/avatar-2.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                            <p class="notify-details"><b>Charles M. Jones</b><small class="">Dummy text of the printing and typesetting industry.</small></p>
                                        </a>

                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="../blupper_templete/Dashor_v1.1.0/Admin/vertical/assets/images/users/avatar-3.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                            <p class="notify-details"><b>Thomas J. Mimms</b><small class="">You have 87 unread messages</small></p>
                                        </a>

                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="../blupper_templete/Dashor_v1.1.0/Admin/vertical/assets/images/users/avatar-4.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                                        aria-haspopup="false" aria-expanded="false">
                                        <img src="../blupper_templete/Dashor_v1.1.0/Admin/vertical/assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle">
                                    </a>
